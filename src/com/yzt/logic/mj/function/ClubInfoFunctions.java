...
//					Player roomCreater = RedisUtil.getPlayerByUserId(String.valueOf(room.getCreateId()));
					...
					jsobj.put("ruleJueGang", room.getRuleJueGang());
					jsobj.put("ruleXuanFeng", room.getRuleXuanFeng());
					jsobj.put("ruleChangMao", room.getRuleChangMao());
					jsobj.put("ruleTuiDaoHu", room.getRuleTuiDaoHu());
					jsobj.put("ruleDaiHun", room.getRuleDaiHun());
					jsobj.put("ruleQiongHu", room.getRuleQiongHu());
					jsobj.put("ruleQingYiSe", room.getRuleQingYiSe());
					jsobj.put("ruleQiDui", room.getRuleQiDui());
					jsobj.put("rulePuFen", room.getRulePuFen());
					jsobj.put("playType", room.getPlayType());
